...
if __name__ == '__main__':
    ...
    AD_group.add_argument('--n_epochs', type=int, default=configs.n_epochs, help='Number of epochs')
    AD_group.add_argument('--batch_size', type=int, default=configs.batch_size, help='Batch size')
    AD_group.add_argument('--learning_rate', type=float, default=configs.learning_rate, help='Learning rate')
    AD_group.add_argument('--n_critic', type=int, default=configs.n_critic, help='Number of discriminator iterations per generator iteration')
    AD_group.add_argument('--alpha', type=int, default=configs.alpha, help='Loss weight alpha')
    AD_group.add_argument('--beta', type=int, default=configs.beta, help='Loss weight beta') 
    AD_group.add_argument('--gamma', type=int, default=configs.gamma, help='Loss weight gamma') 
    AD_group.add_argument('--lambda', type=int, default=configs.lamb, help='Loss weight lambda') 
    AD_group.add_argument('--GPU', type=str, default=configs.GPU, help='GPU ID for training, e.g., cuda:0')
    AD_group.add_argument('--random_state', type=int, default=configs.random_state, help='Random seed')
    AD_group.add_argument('--n_genes', type=int, default=configs.n_genes, help='Number of genes')
    AD_group.add_argument('--run_gmm', type=bool, default=True, help='Run GMM for obtaining binary label')
